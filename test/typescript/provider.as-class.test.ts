...
let providerMethodNotificationRegistered: boolean = false
let providerMethodRequestDispatched: boolean = false
let providerMethodResultSent: boolean = false
let numberOfArgs: number = -1
let ccSettings
let ccSession
